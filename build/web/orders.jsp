...
<html>
    <head>
        ...
        <script>
            <%! String pDelete="";String q="",a="";           String[] products=new String[20];
%>
      ...
      <%
          ...
          catch(Exception ex)
          {
            ...
            String pname="",desc="",image="",price="",rate="",quantity="";int rate1,rate2,rate3,rate4,rate5;double finalrate;
...
String q="select (orders) from "+user[0]+"orders where orders IS NOT NULL";
        ...
        %>
           ...
           else
           {
               rateImage.src="images/5star.png";
                ...
                buttonremove.innerHTML="Cancel Order";
...
Connection con=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/java", "root", "");
Statement st1=con.createStatement();
String q="truncate table "+user[0]+"orders";
st1.execute(q);
              }
                   catch(Exception ex)
                   {
              ...
              %>
                      ...
                      subdiv=document.createElement("div");
                      subdiv.className="class1";
                      txt=document.createTextNode("No Orders");
      ...
      %>
                 ...
                 function removeProduct(product)
            {
                ...
                window.location="servcanorder?id="+pid[1];
    ...
    <body onload="demo()">
        <div  id="container"><h2 style="background-color:background;text-align:center;color:#E1EFEF  ">My Orders</h2></div><div id="buttoncontainer">   
    </body>
</html>
