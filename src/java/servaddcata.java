 ...
 * @author Tushar
 */
@WebServlet(urlPatterns = {"/servaddcata"})
public class servaddcata extends HttpServlet {
...
if ((contentType != null) && (contentType.indexOf("multipart/form-data") >= 0)) {
		...
		int endPos = ((file.substring(0, boundaryLocation)).getBytes()).length;
           ...
           String q="insert into catagory values('"+a+"','"+saveFile+"')";
String q1="create table "+a+"(subcatagories varchar(40),image varchar(60))";
 ...
 out.println(saveFile);
		...
		fileOut.flush();
		fileOut.close();
                response.sendRedirect("catadded.jsp?c="+a);
