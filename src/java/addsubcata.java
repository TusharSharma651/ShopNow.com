 ...
 * @author Tushar
 */
@WebServlet(urlPatterns = {"/addsubcata"})
public class addsubcata extends HttpServlet {
...
String q="insert into "+a+" values('"+b+"','"+saveFile+"')";
String q1="create table "+b+"(products varchar(100),image varchar(40))";
 st.execute(q);
 st.execute(q1);
 out.println(q+" "+q1);
		...
		fileOut.flush();
		fileOut.close();
              // response.sendRedirect("subadded.jsp?s="+b);
        }
    }
    }
