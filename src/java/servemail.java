 ...
 * @author Tushar
 */
@WebServlet(urlPatterns = {"/servemail"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           String phone=request.getParameter("t2");
            HttpSession s2=request.getSession();//get original username
...
String q="update userinfo set username='"+mail+"',phone='"+phone+"' where username='"+user+"' ";
st.execute(q);
