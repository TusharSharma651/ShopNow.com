 ...
 * @author Tushar
 */
@WebServlet(urlPatterns = {"/servchangepersonal"})
public class servchangepersonal extends HttpServlet {
...
String q="update userinfo set firstname='"+fn+"',lastname='"+ln+"' where username='"+user+"'";
